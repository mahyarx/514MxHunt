<div align="center">
  <img src="blob:https://github.com/ba875c3c-1224-47ce-aaac-9aaa1dd92ebc" alt="514MxHunt" style="width:100%" />
  <p></p>
  <sup>
...
```bash
docker run -it mahyarx/514mxhunt
```
...
<details>
  ...
  ```bash
  # 1. Clone the repo
  git clone https://github.com/mahyarx/514mxhunt.git && cd huntkit

  # 2. Build the image
  docker build . -t mahyarx/514mxhunt
  ```
</details>
